...
### Choc ponctuel (AO) suivi d'un choc permanent (LS)
...
#| fig.cap: "Estimations en temps réel de la tendance-cycle des immatriculations de voitures particulières neuves à partir d'août 2018"
#| fig-height: 6
#|
...
### Crise financière de 2008 (deux chocs permanents consécutifs)
...
#| fig.cap: "Estimations en temps réel de la tendance-cycle des ventes au détail et services de restauration (en logarithme) aux États-Unis à partir d'octobre 2008"
#| fig-height: 6
#|
patchwork::wrap_plots(graph_est, ncol = 3)
```
...
### Point de retournement et COVID-19
...
```{r}
#| label: fig-ce16ov2001-est
#| fig.cap: "Estimations en temps réel de la tendance-cycle de l'emploi (en logarithme) aux États-Unis à partir de février 2001"
#| fig-height: 6
patchwork::wrap_plots(graph_est, ncol = 3)
```
...
#| fig.cap: "Estimations en temps réel de la tendance-cycle pour l'IPI dans la construction de véhicules automobiles à partir d'août 1998"
#| fig-height: 6
...
#| fig.cap: "Estimations en temps réel de la tendance-cycle pour l'IPI dans la construction de véhicules automobiles à partir d'août 1999"
#| fig-height: 6
...
#| fig.cap: "Estimations en temps réel de la tendance-cycle pour l'IPI dans la construction de véhicules automobiles à partir d'août 2004"
#| fig-height: 6
#|
patchwork::wrap_plots(graph_est, ncol = 3)
```
...
#| fig.cap: "Estimations en temps réel de la tendance-cycle pour l'IPI dans l'extraction de pétrole brut à partir de juin 2010"
#| fig-height: 6
#|
patchwork::wrap_plots(graph_est, ncol = 3)
```
...
#| fig.cap: "Estimations en temps réel de la tendance-cycle des ventes au détail et services de restauration (en logarithme) aux États-Unis à partir de novembre 2007"
#| fig-height: 6
patchwork::wrap_plots(graph_est, ncol = 3)
```
...
```{r}
#| label: fig-retailx-covid-est
#| fig.cap: "Estimations en temps réel de la tendance-cycle des ventes au détail et services de restauration (en logarithme) aux États-Unis à partir de mars 2020"
#| fig-height: 6
patchwork::wrap_plots(graph_est, ncol = 3)
```
