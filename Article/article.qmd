...
], il est possible de réimplémenter le processus d'estimation locale avec une tendance de degré 2, ce qui a été fait dans l'annexe [-@sec-an-lms-ts] qui présente les estimations des tendances-cycles des différents exemples de cet article.
...
Toutefois, sur des séries réelles, les révisions sont
Ces méthodes conduisent parfois à de fortes révisions lors de l'estimation en temps-réel, ce qui suggère, comme notamment indiqué par @gather2006online, d'utiliser des quantiles plus élevés que la médiane pour les estimations en temps réel avec les méthodes robustes.
