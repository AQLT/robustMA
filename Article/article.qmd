...
alors que les méthodes de désaisonnalisation (comme la méthode X-13ARIMA-SEATS) ont un module de correction des points atypiques.
...
Nous décrivons également construire des moyennes mobiles linéaires qui prennent en compte des informations extérieures, permettant notamment de modéliser des chocs et donc de les rendre robustes à ces derniers, et également comment valider la modélisation retenue par la construction d'intervalles de confiance.
