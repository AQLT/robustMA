...
$$
- Régression des moindres quartiles différenciés --- *Least Quartile Difference* (LQD) [@lqd] TODO
En notant $r_{i,j} = r_i-r_j$
$$
(\widehat{TC}_t=,\hat\beta_{1,t})=\underset{\hat\beta_{0,t},\beta_{1,t}}{\argmin}\left\{ \sum_{i=-h}^h r^2_{t+i} \right\}
$$
